...
The easiest way to play this game, is to play online at [repl.it](https://replit.com/@Camuel/Mastermind-Game?v=1). To play online, click on the green 'run' button. Otherwise, you can download this repository and run main.rb in the command line. 
