...
The easiest way to play this game, is to play online at [repl.it](https://replit.com/@Camuel/rubyMastermind#README.md). To play online, click on the green 'run' button at the top of the repl.it page. Otherwise, you can download this repository and run main.rb in the command line. 
